...
//   logoOuterRing:{ width:80, height:80, borderRadius:40, backgroundColor:'#132030', justifyContent:'center', alignItems:'center', marginBottom:20 },
//   logoInnerCircle:{ width:50, height:50, borderRadius:25, justifyContent:'center', alignItems:'center' },
//   appTitle:{ fontSize:26, fontWeight:'800', color:'#ffb3ac' },
//   appSubtitle:{ fontSize:10, color:'#94a3b8', letterSpacing:2 },
//   card:{ width:'100%', backgroundColor:'#132030', borderRadius:20, padding:25 },
//   welcomeTitle:{ fontSize:22, fontWeight:'700', color:'#fff' },
//   welcomeSubtitle:{ color:'#94a3b8', marginBottom:20 },
//   inputGroup:{ marginBottom:20 },
//   inputLabel:{ fontSize:10, color:'#64748b', marginBottom:5 },
//   labelRow:{ flexDirection:'row', justifyContent:'space-between' },
//   inputWrapper:{ flexDirection:'row', alignItems:'center', backgroundColor:'#020f1e', borderRadius:10, height:50 },
//   inputIcon:{ marginLeft:15 },
//   textInput:{ flex:1, color:'#fff', paddingLeft:10 },
//   visibilityIcon:{ marginRight:15 },
...
//   registerLink:{ color:'#ffb3ac', marginLeft:5, fontWeight:'700' },
//   googleBtn:{ marginTop:20, height:50, backgroundColor:'#1e2b3b', borderRadius:10, flexDirection:'row', justifyContent:'center', alignItems:'center' },
//   googleText:{ color:'#fff', fontWeight:'600', marginLeft:10 }
// });
